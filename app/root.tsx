...
import MyGamesCounter from "~/components/myGamesCounter/MyGamesCounter";
		...
		<html lang="cs">
			...
			<body className="bg-[#eee]">
				<header className="bg-[#001e28] w-full h-[88px] flex items-center justify-start">
					<div className="w-full max-w-[1188px] mx-auto">
						...
						>
							...
							<path
								d="m73.3 0-19.2 41.2 83.1-41.2z"
								fill="#ff0046"
							></path>
						</svg>
					</div>
				</header>
				<nav className="w-full flex flex-row h-[61px] items-center border-b-[1px] border-gray-300">
					<div className="w-full max-w-[1188px] mx-auto">
						<a
							href="#"
							className="flex flex-row text-[#555e61] items-center gap-x-2"
						>
							Oblíbené <MyGamesCounter />
						</a>
					</div>
				</nav>
				<div className="w-full max-w-[1188px] mx-auto pt-8 flex flex-row gap-x-4">
					{
						<div className="w-40">
							<h2 className="mb-4">📌 Připnuté ligy</h2>
							TODO: pinned leagues
							{/*<PinnedLeagues leagues={leagues} client:only />*/}
						</div>
					}
